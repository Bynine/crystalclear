...
; Additional
	const EVENT_FOUGHT_WIREGAUST_JOHTO
	const EVENT_FOUGHT_WIREGAUST_KANTO
	const EVENT_ARTICUNO
	const EVENT_ZAPDOS
	const EVENT_VICTORY_ROAD_MOLTRES
	const EVENT_MEW
	const EVENT_MEWTWO
	const EVENT_WIREGAUST_JOHTO
	const EVENT_WIREGAUST_KANTO
	const EVENT_CELEBI
...
; ???
	...
	const EVENT_TYROGUE_POKEBALL_IN_ELMS_LAB
	const EVENT_EEVEE_POKEBALL_IN_ELMS_LAB
	const EVENT_PICHU_POKEBALL_IN_ELMS_LAB
	const EVENT_5D2
	const EVENT_5D3
	const EVENT_5D4
	const EVENT_5D5
