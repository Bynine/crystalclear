...
ENDM
	...
	move DOUBLESLAP,   EFFECT_DOUBLE_HIT,         25, NORMAL,   100, 25,   0
	move COMET_PUNCH,  EFFECT_MULTI_HIT,          19, NORMAL,   100, 25,   0
	move MEGA_PUNCH,   EFFECT_NORMAL_HIT,         80, NORMAL,    85, 20,   0
	move PAY_DAY,      EFFECT_PAY_DAY,            60, STEEL,    100, 20,   0
	...
	move SWORDS_DANCE, EFFECT_ATTACK_UP_2,         0, STEEL,   100, 30,   0
	move CUT,          EFFECT_NORMAL_HIT,         70, NORMAL,   100, 30,   0
	move GUST,         EFFECT_GUST,               40, FLYING,   100, 35,   0
	move WING_ATTACK,  EFFECT_NORMAL_HIT,         60, FLYING,   100, 30,   0
	move WHIRLWIND,    EFFECT_WHIRLWIND,           0, NORMAL,   100, 20,   0
	move FLY,          EFFECT_FLY,                80, FLYING,   100, 15,   0
	move BIND,         EFFECT_BIND,               50, NORMAL,    85, 20,   0
	move SLAM,         EFFECT_NORMAL_HIT,         80, NORMAL,   100, 15,   0
	...
	move ROLLING_KICK, EFFECT_FLINCH_HIT,         70, FIGHTING,  70, 15,  50
	move SAND_ATTACK,  EFFECT_ACCURACY_DOWN,       0, GROUND,   100, 15,   0
	move HEADBUTT,     EFFECT_FLINCH_HIT,         70, NORMAL,   100, 15,  30
	move HORN_ATTACK,  EFFECT_NORMAL_HIT,         65, STEEL,   100, 25,   0
	move FURY_ATTACK,  EFFECT_MULTI_HIT,          16, NORMAL,    90, 30,   0
	move HORN_DRILL,   EFFECT_OHKO,                1, STEEL,    30,  5,   0
	move TACKLE,       EFFECT_NORMAL_HIT,         40, NORMAL,   100, 35,   0
	move BODY_SLAM,    EFFECT_PARALYZE_HIT,       85, NORMAL,   100, 15,  30
	move WRAP,         EFFECT_BIND,               15, NORMAL,   100, 20,   0
	...
	move PIN_MISSILE,  EFFECT_MULTI_HIT,          20, BUG,       85, 20,   0
	...
	move SUPERSONIC,   EFFECT_CONFUSE_HIT,        20, NORMAL,    80, 20,  50
	move SONICBOOM,    EFFECT_STATIC_DAMAGE,      20, NORMAL,    90, 20,   0
	move DISABLE,      EFFECT_DISABLE,             0, NORMAL,    80, 20,   0
	move ACID,         EFFECT_DEFENSE_DOWN_HIT,   40, POISON,   100, 30,  30
	...
	move STRENGTH,     EFFECT_METAL_CLAW,         80, NORMAL,   100, 15,  20
	move ABSORB,       EFFECT_LEECH_HIT,          25, GRASS,    100, 30,   0
	...
	move SLEEP_POWDER, EFFECT_SLEEP,               0, GRASS,    100, 15,   0
	move PETAL_DANCE,  EFFECT_RAMPAGE,            70, GRASS,    100, 20,   0
	move STRING_SHOT,  EFFECT_SPEED_DOWN_HIT,     10, BUG,      100, 40, 100
	move DRAGON_RAGE,  EFFECT_STATIC_DAMAGE,      40, DRAGON,   100, 10,   0
	move FIRE_SPIN,    EFFECT_BIND,               15, FIRE,      80, 10,   0
	...
	move CONFUSION,    EFFECT_CONFUSE_HIT,        50, PSYCHIC,  100, 25,  20
	...
	move RECOVER,      EFFECT_HEAL,                0, PSYCHIC,   100, 20,   0
	move HARDEN,       EFFECT_DEFENSE_UP,          0, STEEL,    100, 30,   0
	move MINIMIZE,     EFFECT_EVASION_UP,          0, NORMAL,   100, 20,   0
	move SMOKESCREEN,  EFFECT_ACCURACY_DOWN,       0, POISON,   100, 20,   0
	...
	move SELFDESTRUCT, EFFECT_EXPLOSION,         200, FIRE,   100,  5,   0
	move EGG_BOMB,     EFFECT_NORMAL_HIT,        100, FIRE,      75, 10,   0
	move LICK,         EFFECT_PARALYZE_HIT,       40, GHOST,     100, 30,  30
	move SMOG,         EFFECT_POISON_HIT,         30, POISON,   100, 40,  40
	...
	move WATERFALL,    EFFECT_FLINCH_HIT,         80, DRAGON,   100, 15,   0
	move CLAMP,        EFFECT_BIND,               35, WATER,     80, 10,   0
	move SWIFT,        EFFECT_ALWAYS_HIT,         75, NORMAL,   100, 20,   0
	move SKULL_BASH,   EFFECT_SKULL_BASH,        125, ROCK,     100, 15,   0
	move SPIKE_CANNON, EFFECT_MULTI_HIT,          25, STEEL,    100, 10,   0
	move CONSTRICT,    EFFECT_DEFENSE_DOWN_HIT,   30, NORMAL,   100, 40,  60
	move AMNESIA,      EFFECT_SP_DEF_UP_2,         0, PSYCHIC,  100, 20,   0
	move KINESIS,      EFFECT_SPEED_DOWN_HIT,    100, BUG,       80, 10,  50
	move SOFTBOILED,   EFFECT_HEAL,                0, NORMAL,   100, 10,   0
	move HI_JUMP_KICK, EFFECT_JUMP_KICK,          85, FIGHTING,  90, 20,   0
	move GLARE,        EFFECT_PARALYZE,            0, DARK,    90, 30,   0
	move DREAM_EATER,  EFFECT_DREAM_EATER,       100, PSYCHIC,  100, 15,   0
	move POISON_GAS,   EFFECT_POISON_HIT,         30, POISON,    75, 15, 100
	move BARRAGE,      EFFECT_MULTI_HIT,          15, GRASS,    100, 20,   0
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          30, BUG,      100, 15,   0
	...
	move FLASH,        EFFECT_ACCURACY_DOWN_HIT,  35, ELECTRIC, 100, 10, 100
	...
	move CRABHAMMER,   EFFECT_NORMAL_HIT,        100, STEEL,     80, 10,   0
	move EXPLOSION,    EFFECT_EXPLOSION,         250, NORMAL,   100,  5,   0
	move FURY_SWIPES,  EFFECT_TRIPLE_KICK,        27, NORMAL,    80, 25,   0
	...
	move SCARY_FACE,   EFFECT_SPEED_DOWN_2,        0, DARK,    100, 10,   0
	...
	move MUD_SLAP,     EFFECT_ALWAYS_HIT,         60, FLYING,   100, 10, 100
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  70, WATER,     85, 10,  50
	move SPIKES,       EFFECT_SPIKES,              0, GROUND,   100, 20,   0
	move ZAP_CANNON,   EFFECT_PARALYZE_HIT,      150, ELECTRIC,  50,  5, 100
	move SWARM,        EFFECT_MULTI_HIT,          25, BUG,       90, 15,   0
	...
	move DETECT,       EFFECT_FORESIGHT,           0, FIGHTING, 100, 10,   0
	move BONE_RUSH,    EFFECT_TRIPLE_KICK,        30, GROUND,    80, 10,   0
	...
	move FALSE_SWIPE,  EFFECT_FALSE_SWIPE,        80, NORMAL,   100, 40,   0
	...
	move RAPID_SPIN,   EFFECT_RAPID_SPIN,         65, NORMAL,   100, 40,   0
	move SWEET_SCENT,  EFFECT_ATTACK_DOWN_2,       0, GRASS,    100, 20,   0
	move IRON_TAIL,    EFFECT_DEFENSE_DOWN_HIT,  100, STEEL,     75, 15,  30
	move METAL_CLAW,   EFFECT_METAL_CLAW,         60, STEEL,    100, 35,  20
	...
	move PSYCH_UP,     EFFECT_PSYCH_UP,            0, PSYCHIC,   100, 10,   0
	...
	move WHIRLPOOL,    EFFECT_SP_ATK_UP,           0, PSYCHIC,  100, 15,   0
	move BEAT_UP,      EFFECT_BEAT_UP,            10, DARK,    100, 10,   0
	move MOON_DANCE,   EFFECT_ANCIENTPOWER,       60, NORMAL,   100,  5,  25
	move BIGGLYTUFF,   EFFECT_ANCIENTPOWER,      100, FIGHTING, 100,  1, 100
	move MOVEFE,       EFFECT_BEAT_UP,           255, DRAGON,   100,255, 100
