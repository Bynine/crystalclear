...
WiregaustScript:
	...
	faceplayer
	loadfont
	writetext WiregaustText
	cry WIREGAUST
	pause 15
	loadmovesprites
	setevent EVENT_FOUGHT_WIREGAUST_JOHTO
	writecode VAR_BATTLETYPE, BATTLETYPE_WIREGAUST
	loadpokedata WIREGAUST, 40
	startbattle
	disappear $7
	returnafterbattle
	end
...
.PersonEvents:
	...
	person_event SPRITE_GENGAR, 7, 4, SPRITEMOVEDATA_01, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, 0, 0, WiregaustScript, EVENT_WIREGAUST_JOHTO
